...
// Only start the server listening if we are not in a serverless environment (like Vercel)
// or if we are explicitly running locally. Vercel handles the listening part via the exported app.
